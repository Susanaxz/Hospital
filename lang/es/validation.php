...
|--------------------------------------------------------------------------
|
| Aquí puedes especificar mensajes personalizados de validación para los atributos
| utilizando la convención "attribute.rule" para nombrar las líneas. Esto nos
| permite especificar un mensaje personalizado en particular para una regla de atributo dada.
|
*/
